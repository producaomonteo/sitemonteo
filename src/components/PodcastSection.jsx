...
const YOUTUBE_URL = 'https://www.youtube.com/watch?v=89_4jaPNwxg&list=PLVU13ZzvmqTz4hymX_FdcQUmEDDr1bCPG';
          ...
          <div className="podcast-left">
            ...
            <div className="podcast-btns">
              <a
                ...
                className="podcast-platform-btn podcast-platform-btn--spotify"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="podcast-platform-btn podcast-platform-btn--youtube"
              >
