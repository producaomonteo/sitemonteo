...
const StatCounter = ({
  ...
  duration = 2000,
  integerPtBR = false,
  /** Se true, `value` é em bilhões (ex.: 1.3); anima 0→1.3e9 como o contador inteiro, exibe "1,3" + suffix */
  scaleBillions = false
}) => {
          ...
          <div className="proof-main-stats-row">
            <div className="proof-main-stat">
              <h2 className="main-number">
                <StatCounter value="1.3" suffix=" Bi" scaleBillions />
              </h2>
              <p className="main-desc main-desc--emph">VALOR SOB GESTÃO DOS NOSSOS CLIENTES.</p>
            </div>
            <div className="proof-main-stat">
              <h2 className="main-number">
                <StatCounter value="1500" suffix="" integerPtBR />
              </h2>
              <p className="main-desc main-desc--emph">CLIENTES ATENDIDOS NO MUNDO INTEIRO.</p>
            </div>
          </div>
        </div>
